...
CREATE TABLE IF NOT EXISTS `javawebdb`.`cart` (
  ...
  `goods_size` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `javawebdb`.`product` (
  ...
  `pro_price` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`pro_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
START TRANSACTION;
USE `javawebdb`;
INSERT INTO `javawebdb`.`product` (`pro_id`, `pro_name`, `pro_image`, `pro_price`) VALUES ('pro_id', 'pro_name', 'pro_image', 'pro_price');
